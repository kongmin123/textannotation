...
CREATE TABLE `content` (
  ...
  `paracontent` varchar(255) DEFAULT NULL COMMENT '段落内容',
...
CREATE TABLE `task` (
  ...
  `userid` INT(11) NOT NULL COMMENT '用户ID',
  `type` varchar(255) NOT NULL COMMENT '标注类别'
   PRIMARY KEY (`tid`)
  FOREIGN KEY (`userid`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `type` (
  `typeid` int(11) NOT NULL COMMENT '标注类型ID',
  `typename` varchar(255) DEFAULT NULL COMMENT '标注类型名称',
  `typedescription` varchar(255) DEFAULT NULL COMMENT '标注类型描述',
  `createtime` varchar(255) DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `type` VALUES ('1', '标签','信息抽取','2018-12-17 09:40:31');
INSERT INTO `type` VALUES ('2', '分类','用户自定义','2018-12-17 09:40:33');
INSERT INTO `type` VALUES ('3', '两个文本','寻找两个文本之间的关系','2018-12-17 09:40:35');
INSERT INTO `type` VALUES ('4', '多文本','寻找多个文本之间的关系','2018-12-17 09:40:38');
